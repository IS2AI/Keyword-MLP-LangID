...
from models.kwmlp_single_head import KW_MLP_SingleHead
from models.kwmlp_single_head_lang import KW_MLP_SingleHeadLang
...
def get_model(model_config: dict) -> nn.Module:
    ...
    elif model_config["type"] == "kwmlp_single_head":
        return KW_MLP_SingleHead(**model_config)
    elif model_config["type"] == "kwmlp_single_head_lang":
        return KW_MLP_SingleHeadLang(**model_config)
    else:
